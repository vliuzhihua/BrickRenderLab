...
void Renderer::PrepareRender()
{
	...
	Model = new FModel();
	Model->Init("res/models/edible_fruit_ujcxeblva/ujcxeblva_LOD0.obj");
	//std::string dir_name = "res/models/IronMan";
	//std::string file_name = dir_name + "/IronMan.obj";


	//FIBITMAP* Img = FreeImage_Load(FREE_IMAGE_FORMAT::FIF_JPEG, "res\\models\\brick_rough_ue4ifa0va\\ue4ifa0va_4K_Albedo.jpg");
	FIBITMAP* Img = FreeImage_Load(FREE_IMAGE_FORMAT::FIF_JPEG, "res\\models\\edible_fruit_ujcxeblva\\ujcxeblva_4K_Albedo.jpg");
